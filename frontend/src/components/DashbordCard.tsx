import { ArrowCircleRightOutlined, Margin } from "@mui/icons-material"
...
export const LinkCard = ({ name, desc, link }: { name: string, desc: string, link: string }) => {
    return <Link to={link} style={{ textDecoration: "none" }}>
        <Paper elevation={3} sx={{ ...cardStyle, height: "94px", mr: "auto", minWidth: "80%" }}>
            <Box sx={{ my: "auto" }}>
...
export const DateCard = () => {
    ...
    return <Paper elevation={3} sx={{ ...cardStyle, minHeight: "100px", backgroundColor: "#d9d9d9" }}>
        <Box sx={{ my: "auto" }}>
