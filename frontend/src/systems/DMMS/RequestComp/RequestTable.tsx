...
function RequestTable(props: { data: any, query: String, deleteMedicine: any, handleUpdateModalOpen: () => any, setUpdatedmedicine: (p: any) => any, handleLotModalOpen: () => any, setLotModalData: (p: any) => any }) {
