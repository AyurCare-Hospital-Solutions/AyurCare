...
function ManufactureRequeatTable(props: { data: any, query: String, deleteRequest: any, handleUpdateModalOpen: () => any, setUpdatedrequeste: (p: any) => any, handleLotModalOpen: () => any, setLotModalData: (p: any) => any }) {
...
export default ManufactureRequeatTable;
