...
function UpdateManufactureRequestModal(props: any) {
            ...
            <Box sx={style}>
                ...
                <Box id="modal-modal-description" sx={{ mt: 2 }}>
                    <Box
                        ...
                        onSubmit={(e) => {
                            e.preventDefault();
                            props.updateRequest({ updateId, updateName, updateBuffer, updateOrigin, updateUnit })
                            props.onClose();
                        }}
                    >
                        <Box>
...
export default UpdateManufactureRequestModal;