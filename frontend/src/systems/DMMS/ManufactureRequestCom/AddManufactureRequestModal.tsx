...
export default function AddManufactureModal({ open, onClose, addRequest }: { open: boolean, onClose: () => any, addRequest: (data: any) => any }) {
            ...
            <Box sx={style}>
                ...
                <Box id="modal-modal-description" sx={{ mt: 2 }}>
                    <Box
                        ...
                        onSubmit={(e) => {
                            e.preventDefault();
                            addRequest({ amount, buffer, unit: progress, origin });
                            // reset values
                            // setName("");
                            // setBuffer(0);
                            // setUnit("");
                    ...
                    >
                        <Box>
                            <TextField id="outlined-basic1" label="Medicine Amount" variant="outlined" name="amount" onChange={(e) => {
