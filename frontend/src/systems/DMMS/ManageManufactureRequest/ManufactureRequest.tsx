...
export default function ManufactureRequestModel({ open, handleClose, updateRequest, updateStatus, deleteManufactureRequest }: { open: boolean, handleClose: () => any, updateRequest: any, updateStatus: (arg1: number, arg2: string) => any, deleteManufactureRequest: (arg: number) => any }) {
